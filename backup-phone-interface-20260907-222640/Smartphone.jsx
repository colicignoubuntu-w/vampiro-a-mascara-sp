    ...
    <section className="phone-app-screen">
      ...
      <div className="phone-contact-profile">
        ...
        <div>
          ...
          {presentation && (
            <small>
              {presentation.status} · {presentation.mood}
            </small>
          )}
        </div>
      </div>
      ...
      {contact.npcId ? (
        <>
          ...
          {presentation && (
            <div className="phone-contact-relationship">
              <div>
                <span>Relação</span>
              ...
              <div>
                <span>Afeto</span>
                <strong>{presentation.affection}</strong>
              </div>

              <div>
                <span>Confiança</span>
                <strong>{presentation.trust}</strong>
              </div>

              <div>
                <span>Segurança</span>
                <strong>{presentation.safety}</strong>
              </div>

              {presentation.bloodBond > 0 && (
                <div>
                  <span>Laço</span>
                  <strong>{presentation.bloodBond}/3</strong>
                </div>
              )}
            </div>
          )}
      ...
      <div className="phone-message-list">
        ...
        {messages.map(message => (
          <article
            ...
            className={[
              'phone-message',
              message.read ? '' : 'phone-message-unread',
