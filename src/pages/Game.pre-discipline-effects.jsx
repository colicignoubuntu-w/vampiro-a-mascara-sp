...
export default function Game({
  ...
  */
  ...
  function handleChooseDiscipline(
    ...
    /*
      O custo é pago quando o personagem
      realmente decide usar o poder.
    */
  ...
  function resolveDiscipline(
    ...
    /*
      Se a opção tiver uma cena de
      resultado, fazemos a transição.
    */
  ...
  function handleDisciplineContinue() {
    ...
    /*
      Poder sem teste = sucesso direto.
    */
