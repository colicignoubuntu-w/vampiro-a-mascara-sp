...
export default function Game({
  ...
  */
  ...
  useEffect(() => {
    ...
    /*
      Durante uma viagem/evento,
      não deixamos a cena antiga
      sobrescrever a localização.
    */
  ...
  */
  ...
  function applyAutomaticTravelEventEffects(
    ...
    /*
      Neste projeto a fome ainda é
      representada principalmente pela
      quantidade de sangue disponível.

      Depois podemos criar uma escala
      própria de fome separada.
    */
  ...
  */
  ...
  function handleTravelEventTestContinue() {
    ...
    /*
      ======================================
      VIATURA + FALHA CRÍTICA

      Em vez de simplesmente terminar
      a viagem, iniciamos a abordagem.
      ======================================
    */
    ...
    if (
      ...
      updatedGame = {
        ...
        flags: {
          ...
          [`travel_event_${travelEvent.id}_botch`]:
            true,
        },
    ...
    /*
      ...
      Sucesso ou falha comum deixam
      o personagem prosseguir.
      ======================================
    */
  ...
  */
  ...
  function devGoToPolice() {
    ...
    if (!target) {
      window.alert(
        'Cena police_stop não encontrada.'
      )
