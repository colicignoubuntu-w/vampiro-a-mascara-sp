...
} from '../engine/quests/questStoryBridge'
...
if (sunlightSheltered) {
  ...
  */
  ...
  const masquerade =
    ...
    /*
  ========================================
  REAÇÃO PÚBLICA PENDENTE
  ========================================

  Usada principalmente quando o
  personagem chega de uma viagem.

  A flag é consumida antes da rolagem
  para impedir repetição por render.
*/
...
useEffect(() => {
  ...
  /*
    Primeiro consumimos a flag.
    Assim este useEffect nunca fica
  ...
  */
  ...
  /*
    Se não houver sangue visível,
    não existe reação por aparência.
  */
