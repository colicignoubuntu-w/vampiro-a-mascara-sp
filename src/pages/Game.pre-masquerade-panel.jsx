...
export default function Game({
  ...
  */
  ...
  function handlePoliceForceChoice(
    ...
    if (
      ...
      window.alert(
        'Não foi possível resolver esta ação.'
      )
  ...
  */
  ...
  function devGoToPoliceForce() {
    ...
    if (!target) {
      window.alert(
        'Cena police_force não encontrada.'
      )
  ...
  function devShowMasquerade() {
    ...
    window.alert(
      'Estado da Máscara enviado para o console.'
    )
  }
