...
export default function Game({
  ...
  */
  ...
  /*
    ...
    O personagem já está abaixo
    desse limite moral.

    Portanto o jogo NÃO abre
  ...
  */
  ...
  useEffect(() => {
    ...
    /*
      Se ainda precisa de teste,
      deixamos para o próximo
      useEffect abrir a janela.
    */
