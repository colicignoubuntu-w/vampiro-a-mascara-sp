const quests = {
  ...
  voerman_feud: {
    id: 'voerman_feud',
    title: 'O Espelho Partido',
    category: 'main',
    chapter: 'chapter_2',
    initialStatus: 'locked',
    descriptions: {
      default: 'A disputa entre Jeanette, Therese e Bertram Tung é uma rede de favores, suspeitas e versões incompatíveis. A sabotagem na Galeria Noir foi apenas o primeiro passo.',
      meet_jeanette: 'Jeanette quer saber se você veio atrás de Bertram e se está disposto a jogar pelas regras dela.',
      sabotage_gallery: 'Vá à Galeria Noir e estrague a exposição. Corte algumas pinturas, evite ser pego e não transforme vandalismo em massacre.',
      meet_therese: 'Therese descobriu a sabotagem. Ouça o que ela exige em troca de encerrar a disputa com Tung.',
      investigate_ocean_house: 'Vá ao Ocean House Hotel e encontre um objeto pessoal ligado ao espírito que assombra a propriedade.',
      return_ocean_object: 'Decida a quem entregar o objeto do Ocean House. A escolha mudará sua posição com as duas irmãs.',
      reconcile_sisters: 'Encontre Jeanette na cabine dos fundos do Surfside Diner e assegure que Therese não pretende machucá-la.',
      resolve_tung_dispute: 'Volte ao Asylum para saber se Therese cumprirá a promessa sobre Bertram Tung.',
    },
    objectives: [
      { id: 'meet_jeanette', text: 'Conversar com Jeanette sobre Bertram.', required: true, hidden: false },
      { id: 'sabotage_gallery', text: 'Sabotar a exposição da Galeria Noir.', required: true, hidden: false },
      { id: 'steal_donation_box', text: 'Roubar a caixa de doações.', required: false, hidden: false },
      { id: 'avoid_gallery_casualties', text: 'Não matar nenhum mortal.', required: false, hidden: false },
      { id: 'avoid_gallery_exposure', text: 'Sair sem ser identificado.', required: false, hidden: false },
      { id: 'meet_therese', text: 'Enfrentar Therese após a sabotagem.', required: true, hidden: false },
      { id: 'investigate_ocean_house', text: 'Investigar o Ocean House Hotel.', required: true, hidden: false },
      { id: 'return_ocean_object', text: 'Resolver o destino do objeto do espírito.', required: true, hidden: false },
      { id: 'reconcile_sisters', text: 'Encontrar Jeanette no Surfside Diner.', required: true, hidden: false },
      { id: 'resolve_tung_dispute', text: 'Concluir o acordo sobre Bertram Tung.', required: true, hidden: false },
    ],
    rewards: { experience: 5, flags: { voermanFeudResolved: true, bertramLead: true, jeanetteGalleryCompleted: true } },
  },
}
