    ...
    <main className={[
      ...
      <header className="game-topbar">
        ...
        <div className="game-topbar-actions">
          ...
          />
          <Relationships game={game} blocked={interactionBlocked || Boolean(pendingTest)} />
          <NightLife game={game} onChange={persist} blocked={interactionBlocked || Boolean(pendingTest)} />
          <AudioControls />
